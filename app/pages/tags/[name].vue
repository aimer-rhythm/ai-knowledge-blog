...
useHead({
  title: () => `#${tagName.value} - ${t('tags.title')} - ${t('hero.title')}`,
  meta: [
    { name: 'description', content: () => t('tags.description', { name: tagName.value }) },
  ],
})
</script>
  ...
  <div class="container-content py-10 lg:py-16">
    <header class="mb-12">
      ...
      <h1 class="text-4xl sm:text-5xl font-extrabold text-zinc-900 dark:text-zinc-100 tracking-tight">
        <span class="text-primary-500/70 font-semibold mr-1">#</span>{{ tagName }}
      </h1>
